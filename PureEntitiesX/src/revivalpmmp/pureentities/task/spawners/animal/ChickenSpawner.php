 ...
 */
class ChickenSpawner extends BaseSpawner {
    ...
    // ---- chicken spawner specific methods ----


    /**
     * Checks if there is at least 2 blocks of AIR above the position to spawn the chicken to
     *
     * @param Position $pos
     * @return bool
     */
